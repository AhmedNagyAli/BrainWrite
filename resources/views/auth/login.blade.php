        ...
        <div class="w-full max-w-md bg-white rounded-xl shadow-md overflow-hidden">
            ...
            <div class="p-6 sm:p-8">
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-4">
                    ...
                    <button
                        type="submit"
                        class="w-full mt-6 bg-blue-600 hover:bg-blue-700 text-white py-3 px-4 rounded-lg font-medium transition duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                    >
                        دخول
                    </button>
                </form>
